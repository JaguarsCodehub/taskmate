    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ padding: 20 }}>
                <View>
                    <Text style={{ fontSize: 30, fontWeight: "700", textAlign: "center", color: "#212121" }}>Login back to <Text style={{ fontSize: 30, fontWeight: "600", color: "#ffe7c3" }}>start your productivity</Text> from today</Text>
                </View>
                <View style={{ marginTop: 40 }}>
                    ...
                    <TextInput
                        ...
                        cursorColor={"black"}
                        style={{ marginTop: 10, borderColor: "black", borderWidth: 1, paddingHorizontal: 10, paddingVertical: 10, borderRadius: 10 }}
                    />
                ...
                <View style={{ marginTop: 10 }}>
                    <Link href={"/(auth)/signup"}>
                        <Text style={{ fontSize: 15, fontWeight: "600", textAlign: "center" }}>Seems you are new, Signup here</Text>
                    </Link>
                </View>
            </View>
        </View>
